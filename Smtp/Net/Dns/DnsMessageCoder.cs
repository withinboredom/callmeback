...
namespace Smtp.Net.Dns
{
    internal class DnsMessageCoder
    {
        ...
        public static byte[] EncodeDnsMessage(DnsMessage message)
        {
            ...
            foreach (DnsResource record in message.AuthoritativeRecords)
            {
        ...
        */
        public static byte[] EncodeHeader(DnsMessage message)
        {
            ...
            fields |= (int)message.QueryKind << 11;
            ...
            WriteUInt16BE(writer, (UInt16)message.AuthoritativeRecords.Count);
        ...
        */
        ...
        public static DnsMessage DecodeDnsMessage(byte[] msgData)
        {
            ...
            {
                message.AuthoritativeRecords.Add(ReadResourceRecord(reader));
            }
